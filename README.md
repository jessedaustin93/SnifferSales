...
Commercial planning repo for SnifferOps productization, sales, hardware SKUs,
parts planning, cases, fulfillment, and launch work.

This repo is separate from the engineering app repo:

- Software / appliance source: `jessedaustin93/Sniffer-Ops`
- Commercial planning: `jessedaustin93/SnifferSales`
